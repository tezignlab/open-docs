...
你需要将素材组选择器的链接用 iframe 嵌入你的系统，你的代码和组件会基于[postMessage](https://developer.mozilla.org/en-US/docs/Web/API/Window/postMessage)来进行通信交互数据。
...
<html lang="zh-CN">
  ...
  <body>
    ...
    <iframe
      src="https://xxx.tezign.com/dam_enterprise/material_group_selector"
      id="iframe"
    />
  </body>
</html>
...
const iframeUrl =
  'https://xxx.tezign.com/dam_enterprise/material_group_selector';
